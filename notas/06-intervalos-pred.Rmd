...
- El error de predicción es relativamente chico (tenemos predicciones muy precisas),
...
que no conocemos de antemano, de forma que la estructura de costos de un error es compleja y sólo parcialmente definida. Ninguna pérdida usual refleja correctamente el costo-beneficio de usar un modelo.
...
serie de decisiones acerca de productos, promociones, etc. (no definidos de antemano
...
aún cuando la probabilidad de que sea una imagen "normal" es alta (digamos 75%), una probablidad de 20% de que sea cancerígena debe ser puesta frente a los tomadores de decisiones.
