...
Si queremos hacer una predicción en $x_0$, el método de k-vecinos más cercanos funciona mejor cuando 
...
En dimensión alta, para la mayoría de las $x_0$ donde queremos hacer predicciones
...
de sesgo (por extrapolación a regiones no relevantes).
